...
namespace EBEST
{
    public partial class pedidos : Form
    {
        ...
        private void pedidos_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[20].HeaderCell.Style.BackColor = Color.White;
            dataGridView1.Columns[20].DefaultCellStyle.BackColor = Color.LightBlue;

            dataGridView1.Columns[21].HeaderCell.Style.BackColor = Color.White;
            dataGridView1.Columns[21].DefaultCellStyle.BackColor = Color.LightBlue;

            dataGridView1.Columns[22].HeaderCell.Style.BackColor = Color.White;
            dataGridView1.Columns[22].DefaultCellStyle.BackColor = Color.LightBlue;

            dataGridView1.Columns[23].HeaderCell.Style.BackColor = Color.White;
            dataGridView1.Columns[23].DefaultCellStyle.BackColor = Color.LightBlue;
        ...
        private void btnpagado_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OleDbCommand command = new OleDbCommand();
                command.Connection = connection;
                string query = "select * from pedidospagados";
                command.CommandText = query;
